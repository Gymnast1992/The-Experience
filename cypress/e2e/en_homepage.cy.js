...
describe('Homepage_EN', () => {
  ...
  it('TC_02, Verify user can switch language from English to French', () => {
    cy.contains('FR').click({ force: true });
    cy.get('h1.t-title').should('have.text', "l'Expérience");
  });

  it('TC_03, Verify 3 header buttons are displayed in the hamburger menu', () => {
  ...
  it('TC_04, Verify EN and FR language buttons are visible in the header', () => {
    cy.get('a [type="button"]').click({ force: true });
